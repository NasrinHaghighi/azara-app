...
function MovingText() {
  ...
  return (
    ...
    <div className="relative flex overflow-x-hidden  font-bold bg-bgGolden " dir="rtl">
      <div className='absolute left-0 lg:w-48 md:w-24 w-14 bg-gradient-to-r from-bg to-transparent z-10 h-full'></div>
  ...
  <div className='absolute rigth-0 lg:w-48 md:w-24 w-14 bg-gradient-to-l from-bg to-transparent z-10 h-full'></div>
</div>
</>
  )  
}
