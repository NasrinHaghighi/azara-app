...
import Photo from '../../../public/img/facegenerate4.png'
...
return (
<div className='grid grid-cols-11 place-center  lg:grid-cols-12 lg:grid-rows-1 gap-0 lg:gap-6  h-100 w-full h-full lg:mb-14 mb-64 
'>

 <div className="lg:block hidden relative col-span-6  text-right  "
// style={{
...
<div className="lg:col-span-6 col-span-12 flex lg:justify-start  items-center mt-24 h-full lg:-mr-8 m-auto">
<Title />
</div>
</div>
)
