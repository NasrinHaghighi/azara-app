...
async function Article() {
 ...
 <div className='lg:order-2 order-2 px-5'>
   ...
   <PoemUniqe   selectedPosts={selectedPosts} />
        ...
        <div className=' text-center h-fit lg:sticky  top-10 lg:order-2 order-1 px-5'> 
...
<div className='   md:w-[500px] md:h-[350px] w-[250px] h-[300px]flex justify-center items-center  m-auto mb-14 '>
    ...
    <p className='text-l md:text-md'>شاعر اشعار خود را در قالبهای غزل ، مثنوی ، چهار پاره ، دوبیتی ، رباعی و شعر نو سروده است و بیشتر اشعار خود را در موضوع های عاشقانه ، عارفانه و اجتماعی سروده است </p>
        </div>
    </div>
    </>
  )
