...
const handleInputChange = (event:any) => {
  ...
  return (
    ...
    <input  type="text" className=" h-10 w-full rounded-md bg-gray-300 px-4 font-thin outline-none drop-shadow-sm transition-all duration-200 ease-in-out  focus:ring-2 " placeholder='جستجو...' 
